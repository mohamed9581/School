                    ...
                    <div class="card-body">
                        <div id="customerList">
                            <div class="row g-4 mb-3">
                                <div class="p-1">
                                    <form method=POST id="addQuestion" action="{{ route('questionStore') }}"
                                        autocomplete="off">
                                        @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="hidden" class="form-control" value="{{ $quizz_id }}"
                                                ...
                                                <div class="mb-3">
                                                    <label for="answers"
                                                        class="form-label">{{ trans('Questions_trans.reponses') }} <small
                                                            class="text-danger">({{ trans('Questions_trans.tirets') }})</small></label>
