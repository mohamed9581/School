                        ...
                        <div id="customerList">
                            <div class="row g-4 mb-3">
                                <div class="col-sm-auto">
                                    <div>
                                        <a href="{{ route('questionsCreate', $quizz->id) }}" class="btn btn-success add-btn"
                                    ...
                                    <tbody class="list form-check-all" id="militaireBody">
                                        @foreach ($questions as $index => $question)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('questionsEdit', $question->id) }}"
                                                        title="{{ trans('Questions_trans.Edit') }}"
                                                        class="editQuestion btn btn-sm btn-success edit-item-btn"><i
                                                    ...
                                                    <button id="btnDelete" question_name="{{ $question->title }}"
                                                        ...
                                                        class="deleteQuestion btn btn-sm btn-danger edit-item-btn"
