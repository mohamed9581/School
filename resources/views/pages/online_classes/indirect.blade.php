...
@endsection
@section('pagetitle')
    {{ trans('Zoom_trans.indirect_Online_Classe') }}
@endsection
                    ...
                    <div class="card-body">
                        <div id="customerList">
                            <div class="row g-4 mb-3">
                                <div class="p-1">
                                    <form method=POST id="addQuizze" action="{{ route('online_classes.storeIndirect') }}"
                                        autocomplete="off">
                                        @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <div class="mb-3">
                                                    <label for="meeting_id"
                                                        class="form-label">{{ trans('Zoom_trans.meeting_id') }}</label>
                                                    <input type="text" class="form-control"
                                                        value="{{ old('meeting_id') }}" name="meeting_id" id="meeting_id"
                                                        autocomplete="off">
                                                    {{-- ---------------------debut pour afficher l'erreur------------------------ --}}
                                                    <small id='meeting_id_error' class="form-text text-danger"></small>
                                                    {{-- ---------------------fin pour afficher l'erreur------------------------ --}}
                                                </div>
                                            </div>
                                            <!--end col-->
                                            ...
                                            <div class="col-md-2">
                                                <div class="mb-3">
                                                    <label for="password"
                                                        class="form-label">{{ trans('Zoom_trans.meeting_password') }}</label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="start_url"
                                                        class="form-label">{{ trans('Zoom_trans.lienDebut') }}</label>
                                                    <input type="text" class="form-control"
                                                        value="{{ old('start_url') }}" name="start_url" id="start_url"
                                                        autocomplete="off">
                                                    {{-- ---------------------debut pour afficher l'erreur------------------------ --}}
                                                    <small id='start_url_error' class="form-text text-danger"></small>
                                                    {{-- ---------------------fin pour afficher l'erreur------------------------ --}}
                                                </div>
                                            </div>
                                            <!--end col-->
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="join_url"
                                                        class="form-label">{{ trans('Zoom_trans.lienRejoint') }}</label>
                                                    <input type="text" class="form-control"
                                                        value="{{ old('join_url') }}" name="join_url" id="join_url"
                                                        autocomplete="off">
                                                    {{-- ---------------------debut pour afficher l'erreur------------------------ --}}
                                                    <small id='join_url_error' class="form-text text-danger"></small>
                                                    {{-- ---------------------fin pour afficher l'erreur------------------------ --}}
                                                </div>
                                            </div>
                                            <!--end col-->
