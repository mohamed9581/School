...
@section('title')
    {{ trans('Payments_trans.title_page') }} <span class="text-success">{{ $student->name }} </span>
@endsection
@section('pagetitle')
    {{ trans('Payments_trans.title_page') }}
@endsection
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="p-3">
                    ...
                    <form class=" row mb-30" action="{{ route('payment_students.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="final_balance"
                                        class="form-label">{{ trans('Payments_trans.final_balance') }}</label>
                                    <input type="text"
