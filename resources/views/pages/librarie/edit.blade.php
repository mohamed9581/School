                    ...
                    <div class="card-body">
                        <div id="customerList">
                            <div class="row g-4 mb-3">
                                <div class="p-1">
                                    <form method=POST id="addBook" action="{{ route('libraries.update', $book->id) }}"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select id="grade_id" name="grade_id"
                                                        ...
                                                        @foreach ($grades as $grade)
                                                            <option {{ $book->grade_id == $grade->id ? 'selected' : '' }}
                                                                value="{{ $grade->id }}">
                                                                {{ $grade->Name }}
                                                            </option>
                                                        @endforeach
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <select id="classe_id" name="classe_id"
                                                        class="form-select form-control mb-3 bg-light "
                                                        aria-label="Default select example">
                                                        <option selected value="{{ $book->classe_id }}">
                                                            {{ $book->classe->nomClasse }}
                                                        </option>
                                                        {{-- à remplir par ajax --}}
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <select id="section_id" name="section_id"
                                                        class="form-select form-control mb-3 bg-light "
                                                        aria-label="Default select example">
                                                        <option selected value="{{ $book->section_id }}">
                                                            {{ $book->section->nomSection }}
                                                        </option>
                                                        {{-- à remplir par ajax --}}
                                                    </select>
                                                    {{-- ---------------------debut pour afficher l'erreur------------------------ --}}
