                                    ...
                                    <tbody class="list form-check-all" id="studentBody">
                                        @foreach ($children as $index => $child)
                                            <tr>
                                                ...
                                                <td>{{ $child->classe->nomClasse }}</td>
                                                <td>{{ $child->section->nomSection }}</td>
                                                <td>
                                                    <a href="{{ route('absenceStudent', $child->id) }}"
                                                        title="{{ trans('Parent_trans.attendance') }}"
                                                        class="editQuestion btn btn-sm btn-primary edit-item-btn"><i
                                                            class="bx bxs-show"></i>
                                                    </a>
                                                    <a href="{{ route('examEnfant', $child->id) }}"
