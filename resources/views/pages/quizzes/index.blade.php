                        ...
                        <div id="customerList">
                            <div class="row g-4 mb-3">
                                <div class="col-sm-auto">
                                    <div>
                                        <a href="{{ route('quizzes.create') }}" class="btn btn-success add-btn"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('quizzes.edit', $quizze->id) }}"
                                                        ...
                                                        {{ trans('Quizzes_trans.Edit') }}</a>

                                                    <a href="{{ route('questions.show', $quizze->id) }}"
                                                        title="{{ trans('Questions_trans.add_Question') }}"
                                                        class="editQuestion btn-sm btn-warning edit-item-btn"><i
                                                            class="ri-edit-2-line"></i>
                                                        {{ trans('Questions_trans.add_Question') }}</a>
                                                    <button id="btnDelete" quizze_name="{{ $quizze->name }}"
                                                        ...
                                                        {{ trans('Quizzes_trans.delete_Quizze') }}</button>
