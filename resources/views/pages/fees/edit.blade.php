                    ...
                    <div class="card-body">
                        <div id="customerList">
                            <div class="row g-4 mb-3">
                                <div class="p-1">
                                    <form method=POST id="editFee" action="{{ route('fees.update', $fee->id) }}"
                                        autocomplete="off">
                                        @csrf
                                        {{ method_field('patch') }}
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{ $fee->getTranslation('title', 'ar') }}" name="title[ar]"
                                                        id="title">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{ $fee->getTranslation('title', 'en') }}" name="title[en]"
                                                        id="title_en">
                                                    {{-- ---------------------debut pour afficher l'erreur------------------------ --}}
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control" value="{{ $fee->amount }}"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select id="grade_id" name="grade_id"
                                                        ...
                                                        @foreach ($grades as $grade)
                                                            <option {{ $fee->grade_id == $grade->id ? 'selected' : '' }}
                                            ...
                                            <div class="col-md-3">
                                                <div class="mb-3">
                                                    ...
                                                    <select id="classe_id" name="classe_id"
                                                        class="form-select form-control mb-3 bg-light "
                                                        aria-label="Default select example">
                                                        <option selected value="{{ $fee->classe_id }}">
                                                            {{ $fee->classe->nomClasse }}
                                                        </option>
                                                        {{-- à remplir par ajax --}}
                                            ...
                                            <div class="col-md-3">
                                                <div class="mb-3">
                                                    ...
                                                    <select id="fee_type" name="fee_type"
                                                        ...
                                                        aria-label="Default select example">
                                                        <option value="1"
                                                            {{ $fee->fee_type == '1' ? 'selected' : '' }}>
                                                            {{ trans('Fees_trans.fraisScolarite') }}
                                                        </option>
                                                        <option value="2"
                                                            {{ $fee->fee_type == '2' ? 'selected' : '' }}>
                                                            {{ trans('Fees_trans.fraisTransport') }}
                                                        </option>
                                                    </select>
                                                    {{-- ---------------------debut pour afficher l'erreur------------------------ --}}
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" name="description" id="description" rows="3">{{ $fee->description }}</textarea>
                                                    {{-- ---------------------debut pour afficher l'erreur------------------------ --}}
