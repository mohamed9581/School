     ...
     <div id="customerList">
         <div class="row g-4 mb-3">
             <div class="col-sm-auto">
                 <div>
                     <button type="button" class="btn btn-success add-btn" wire:click="showformadd" id="create-btn"><i
                         ...
                         <tr>
                             ...
                             <td>
                                 <button class="editGrade btn btn-sm btn-success edit-item-btn" data-bs-toggle="modal"
                                     wire:click="edit({{ $myParent->id }})">{{ trans('Parent_trans.Edit') }}</button>
                                 <button class="deleteGrade btn btn-sm btn-danger delete-item-btn"
                                     wire:click="delete({{ $myParent->id }})">{{ trans('Parent_trans.Delete') }}</button>
