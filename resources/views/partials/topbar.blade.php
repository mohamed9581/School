            ...
            <div class="d-flex">
                ...
                <form class="app-search d-none d-md-block">
                    <div class="position-relative">
                        <input type="text" class="form-control" placeholder="{{ trans('pagination.search') }}..."
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                        ...
                        <img id="header-lang-img" src="{{ URL::asset('assets/images/flags/en.png') }}"
                                ...
                                <li>
                                    <a rel="alternate" hreflang="{{ $localeCode }}"
                                        ...
                                        <img id="header-lang-img"
                                            src="{{ URL::asset('assets/images/flags/' . $localeCode . '.png') }}"
                                            alt="Header Language" height="20" class="rounded">
                                        {{ $properties['native'] }}
                                    </a>
                                </li>
                                        ...
                                        @foreach (Auth::user()->unreadNotifications as $notification)
                                            <div
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-1">
                                                        <a href="{{ route('absenceNotification', ['id' => $notification->data['enfant_id'], 'dateAbsence' => $notification->data['dateAbsence']]) }}"
                                                            class="stretched-link">
                                                            <h6 class="mt-0 mb-2 lh-base">Votre enfant
                                                                <b>{{ $notification->data['enfant'] }}</b> a été absent
                                                                le
                                                                <span
                                                                    class="text-secondary">{{ $notification->data['dateAbsence'] }}</span>
                                                            </h6>
                                                        </a>
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                        ...
                        <span class="d-flex align-items-center">
                            {{-- @if (auth('student')->check())
                                <img class="rounded-circle header-profile-user"
                                    src="{{ URL::asset('attachments/students/' . Auth::user()->name . '/profile/' . Auth::user()->photo) }}"
                                    alt="Header Avatar">
                            @else
                                <img class="rounded-circle header-profile-user"
                                    src="{{ URL::asset('assets/images/users/avatar-1.jpg') }}" alt="Header Avatar">
                            @endif --}}
                            {{ afficher_image(Auth::user()->photo, ['alt' => 'photo de ' . Auth::user()->name, 'class' => 'rounded-circle header-profile-user'], Auth::user()->name, auth('student')->check() == 'student' ? Auth::user()->gender->getTranslation('name', 'en') : 'Male') }}
                            <span class="text-start ms-xl-2">
                                @if (auth('parent')->check())
                                    <span
                                        class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{ Auth::user()->name_Father }}</span>
                                @else
                                    <span
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="{{ route('settings.index') }}"><span
                                ...
                                class="align-middle">{{ trans('main_trans.setting') }}</span></a>
                        ...
                        <a class="dropdown-item" href="{{ route('logout', 'web') }}"
                            onclick="event.preventDefault();
                                ...
                                class="align-middle" data-key="t-logout">{{ trans('auth.logout') }}</span></a>
                        @if (auth('student')->check())
