    ...
    public function nextQuestion($question_id, $score, $answer, $right_answer)
    {
        ...
        if ($stuDegree == null) {
            ...
            if ($stuDegree->question_id >= $this->data[$this->counter]->id) {
                ...
                $stuDegree->abuse = '1';
                $stuDegree->save();
                flash()->addError( trans('Quizzes_trans.annule_Quizze'));
                // return redirect('student/exam/question');
                return redirect()->to('/student/exam');
            } else {
        ...
        if ($this->counter < $this->questioncount - 1) {
            ...
            flash()->addSuccess( trans('Quizzes_trans.success_Quizze'));
            // return redirect('student/exam/question');
            return redirect()->to('/student/exam');
